...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $("#admin").html("");
            $("#admin").html("<span class=\"glyphicon glyphicon-user\"></span>&nbsp;${admin.adminName}");
...
<body>
    <div id="main">
        <div class="header">
            <div>
                <h1 style="font-weight: bold;color: lightseagreen;">大学毕业生就业信息管理平台&nbsp;&nbsp;&nbsp;<span class="span">|&nbsp;&nbsp;&nbsp;管理员平台</span></h1>
            </div>
        </div>
        ...
        <div class="navbar">
            ...
            <a class="right" style="color: #f37b1d" id="back"><span class="glyphicon glyphicon-log-out">&nbsp;退出</span></a>
            <a class="right name" style="color: snow;" id="admin"></a>
        </div>

        <div id="middle" class="row col-lg-12" style="background-color: snow;height: 900px;">
            <div  id="left" class="col-lg-2 left">
                    <ul>
                        <li><a href="${pageContext.request.contextPath}/student/queryStuByPage" target="iframe"><span class="glyphicon glyphicon-th-list" style="font-weight: bold;font-size: 1.1em;">&nbsp;学生信息</span></a></li>
                        <li><a href="${pageContext.request.contextPath}/company/queryComByPage" target="iframe"><span class="glyphicon glyphicon-briefcase" style="font-weight: bold;font-size: 1.1em;">&nbsp;企业信息</span></a></li>
                        ...
                        <li><a href="${pageContext.request.contextPath}/admin/adminCenter?adminNo=${admin.adminNo}" target="iframe"><span class="glyphicon glyphicon-magnet" style="font-weight: bold;font-size: 1.1em;">&nbsp;个人中心</span></a></li>
