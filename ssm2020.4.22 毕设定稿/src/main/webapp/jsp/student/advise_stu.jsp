    ...
    $(function () {
        ...
        if(tbody == 0){
            ...
            $("#div1").append("<div class=\"panel panel-primary noInter center-block\">\n" +
                ...
                "\t\t<span style=\"color: lightseagreen;font-weight: bold\">暂无就业推荐信息 请等待...</span>\n" +
                "\t</div>\n" +
                "</div>");
        }
...
<body>
    <div id="div1">
        <div id="div2">
            <div id="div3"><span class="glyphicon glyphicon-star"></span><span>&nbsp;就业推荐</span></div>
        </div>

<%--        <div class="panel panel-primary noInter center-block">--%>
<%--            <div class="panel-heading text-center">--%>
<%--            <h2 class="panel-title">提示</h2>--%>
<%--        </div>--%>
<%--            <div class="panel-body text-center">--%>
<%--                <span style="color: lightseagreen;font-weight: bold">就业推荐中的企业招聘信息可提交求职申请</span>--%>
<%--            </div>--%>
<%--        </div>--%>
        <div class="alert alert-success" style="margin-top: 30px;">
            ...
            <strong>Tips：</strong>就业推荐中的企业招聘信息可提交求职申请
        </div>
...
<%--                                <a src=""><span class="glyphicon glyphicon-pencil"></span></a>&nbsp;--%>
        ...
        <div id="div6">
            ...
            <ul class="pagination" id="page">
                <li><a href="${pageContext.request.contextPath}/advertise/queryAdverByPageAdvise?stuNo=${student.stuNo}&stuAddress=${student.stuAddress}&pageNo=${advertisePageModel.firstPage}">&laquo;</a></li>
                <li><a href="${pageContext.request.contextPath}/advertise/queryAdverByPageAdvise?stuNo=${student.stuNo}&stuAddress=${student.stuAddress}&pageNo=${advertisePageModel.prePage}">Previous</a></li>
                <li><a href="#">${advertisePageModel.pageNo}</a></li>
                <li><a href="${pageContext.request.contextPath}/advertise/queryAdverByPageAdvise?stuNo=${student.stuNo}&stuAddress=${student.stuAddress}&pageNo=${advertisePageModel.nextPage}">Next</a></li>
                <li><a href="${pageContext.request.contextPath}/advertise/queryAdverByPageAdvise?stuNo=${student.stuNo}&stuAddress=${student.stuAddress}&pageNo=${advertisePageModel.lastPage}">&raquo;</a></li>
            </ul>
        </div>
    </div>
