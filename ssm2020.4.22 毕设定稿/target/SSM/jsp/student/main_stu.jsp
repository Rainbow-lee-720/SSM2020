...
<head>
    ...
    <style>
        * {
        ...
        .bottom-div{
            ...
            padding: 20px;
            text-align: center;
            background: url("../../resources/images/footer3.png") no-repeat;
            background-size: cover;
        }
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $("#student").html("");
            $("#student").html("<span class=\"glyphicon glyphicon-user\"></span>&nbsp;${student.stuName}");
...
<body>
    <div id="main">
        <div class="header">
            <div>
                <h1 style="font-weight: bold;color: lightseagreen;">大学毕业生就业信息管理平台&nbsp;&nbsp;&nbsp;<span class="span">|&nbsp;&nbsp;&nbsp;学生平台</span></h1>
            </div>
        </div>
        ...
        <div class="navbar">
            ...
            <a class="right name" style="color: snow;" id="student"></a>
        </div>

        <div id="middle" class="row col-lg-12" style="background-color: snow;height: 900px;">
            <div  id="left" class="col-lg-2 left">
                    <ul>
                        <li><a href="${pageContext.request.contextPath}/advertise/queryAdverByPage" target="iframe"><span class="glyphicon glyphicon-th-list" style="font-weight: bold;font-size: 1.1em;">&nbsp;招聘信息</span></a></li>
                        <li><a href="${pageContext.request.contextPath}/company/queryComByPage" target="iframe"><span class="glyphicon glyphicon-tasks" style="font-weight: bold;font-size: 1.1em;">&nbsp;企业信息</span></a></li>
                        <li><a href="${pageContext.request.contextPath}/advertise/queryAdverByPageAdvise?stuNo=${student.stuNo}" target="iframe"><span class="glyphicon glyphicon-star" style="font-weight: bold;font-size: 1.1em;">&nbsp;就业推荐</span></a></li>
                        <li><a href="${pageContext.request.contextPath}/employ/queryEmpByPage?stuNo=${student.stuNo}" target="iframe"><span class="glyphicon glyphicon-tags" style="font-weight: bold;font-size: 1.1em;">&nbsp;就业信息</span></a></li>
                        ...
                        <li><a href="${pageContext.request.contextPath}/interview/queryInterByStuNo?interStuNo=${student.stuNo}" target="iframe"><span class="glyphicon glyphicon-leaf" style="font-weight: bold;font-size: 1.1em;">&nbsp;求职信息</span></a></li>
                        <li><a href="${pageContext.request.contextPath}/student/stuCenter?stuNo=${student.stuNo}" target="iframe"><span class="glyphicon glyphicon-magnet" style="font-weight: bold;font-size: 1.1em;">&nbsp;个人中心</span></a></li>
