...
<div id="main">
    ...
    <div class="bottom-div">
        <p style="font-size: 16px;text-align: center;font-weight: bold;font-family: Franklin Gothic Medium";>©NUIST BINJIANG  大学毕业生就业信息管理平台 Version1.0 2020-01-01</p>
        <p style="font-size: 14px;text-align: center;font-weight: bold;font-family: Franklin Gothic Medium";>-2016软工二 20162344068-</p>
    </div>
</div>
</body>
</html>