...
<script type="text/javascript">
    $(function () {
        ...
        $("#submit").click(function () {
            ...
            if(adverPosition == "" || adverPosition == null){
            ...
            }else if(adverRequire == "" || adverRequire == null){
                ...
                $.ajax({
                    ...
                    url : "${pageContext.request.contextPath}/advertise/updateAdvertise",
...
<body>
    <div id="div1">
        <div id="div2">
            <div id="div3"><span class="glyphicon glyphicon-tag"></span><span>&nbsp;更新招聘信息</span></div>
            <div id="div5">
                <!-- 新增Back按钮 -->
                <button class="btn btn-primary back" data-toggle="modal" data-target="#myModal">
        ...
        <div class="alert alert-success">
            ...
            <strong>提示：</strong>您可以在此页面更新企业招聘信息<b>(企业中心数据可能有更新的情况 请随时更新招聘信息)</b>
        </div>

        <div id="div4">
            <div style="padding: 25px 100px 10px;">
                <p style="color: lightseagreen;font-weight: bold;font-size:20px;">丨<span>&nbsp;&nbsp;</span>招聘信息更新</p>
                <hr class="span2">
                <br>
                ...
                <form class="bs-example bs-example-form" role="form">
                    <div class="input-group">
                        ...
                        <input id="adverNo" type="text" class="form-control" value="${adverInfo.adverNo}" disabled>
                    </div>
                    <br>
                    <div class="input-group">
                        <span class="input-group-addon span">企编：</span>
                        <input id="adverComNo" type="text" class="form-control" value="${adverInfo.adverComNo}" disabled>
                    </div>
                    <br>
                    <div class="input-group">
                        <span class="input-group-addon span">名称：</span>
                        <input id="adverComName" type="text" class="form-control" value="${adverInfo.adverComName}" disabled>
                    </div>
                    <br>
                    <div class="input-group">
                        <span class="input-group-addon span">电话：</span>
                        <input id="adverComPhone" type="text" class="form-control" value="${adverInfo.adverComPhone}" disabled>
                    </div>
                    <br>
                    <div class="input-group">
                        <span class="input-group-addon span">地址：</span>
                        <textarea id="adverComAddress" type="text" class="form-control" disabled>${adverInfo.adverComAddress}</textarea>
                    </div>
                    <br>

                    <div class="input-group">
                        <span class="input-group-addon span">职位：</span>
                        <input id="adverPosition" type="text" class="form-control" style="font-weight: bold;color: #8799a3;" placeholder="请编辑您的招聘职位" value="${adverInfo.adverPosition}">
                        <div id="errAdverPosition" style="color: orange;"></div>
                    </div>
                    <br>
                    <div class="input-group">
                        <span class="input-group-addon span">人数：</span>
                        <input id="adverCount" type="text" class="form-control" style="font-weight: bold;color: #8799a3;" placeholder="请编辑您的招聘人数" value="${adverInfo.adverCount}">
                        <div id="errAdverCount" style="color: orange;"></div>
                    </div>
                    <br>
                    <div class="input-group">
                        <span class="input-group-addon span">薪资：</span>
                        <input id="adverSalary" type="text" class="form-control" style="font-weight: bold;color: #8799a3;" placeholder="请编辑您的招聘薪资待遇" value="${adverInfo.adverSalary}"/>
                        <div id="errAdverSalary" style="color: orange;"></div>
                    </div>
                    <br>
                    <div class="input-group">
                        <span class="input-group-addon span">工作地：</span>
                        <textarea id="adverLocation" type="text" class="form-control"  style="font-weight: bold;color: #8799a3;" placeholder="请编辑您的入职工作地">${adverInfo.adverLocation}</textarea>
                        <div id="errAdverLocation" style="color: orange;"></div>
                    </div>
                    <br>
                    <div class="input-group">
                        <span class="input-group-addon span">要求：</span>
                        <textarea id="adverRequire" type="text" class="form-control"  style="font-weight: bold;color: #8799a3;" placeholder="请编辑您的招聘要求">${adverInfo.adverRequire}</textarea>
                    ...
                    <div class="row form-group" style="margin: 50px auto;">
                        ...
                        <button type="button" class="btn btn-danger back" style="position:relative;left: 620px;">退出</button>
                    </div>
                </form>
            </div>
